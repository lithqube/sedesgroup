...
/*
  ...
  In creation of Cool Timeline free version, we are also thankful 
  to Timeline Express plugin creators. Some of our short-code generator 
  code was inspired by Timeline Express 
  But we have removed this code after version 1.1.4"

 * 
 */
/** Configuration * */
if (!defined('COOL_TIMELINE_VERSION_CURRENT'))
    define('COOL_TIMELINE_VERSION_CURRENT', '1.1.6');
